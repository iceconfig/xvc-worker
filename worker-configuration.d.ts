/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a42784e8f4ef8b5b9523b021b5354642)
// Runtime types generated with workerd@1.20260317.1 2026-03-10 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TaskObject";
	}
	interface Env {
		TASK_KV: KVNamespace;
		GEMINI_API_KEY: string;
		DEEPSEEK_API_KEY: string;
		TASK_OBJECT: DurableObjectNamespace<import("./src/index").TaskObject>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GEMINI_API_KEY" | "DEEPSEEK_API_KEY">> {}
}
